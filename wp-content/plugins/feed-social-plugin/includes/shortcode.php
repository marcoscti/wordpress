        ...
        <div class="fs-post-modal-content">
            ...
            <div class="fs-post-modal-right">
                ...
                <div class="fs-post-modal-footer">
                    ...
                    <div class="fs-user-data-wrapper">
                        <small id="fs-user-data" class="fs-user-data"></small>
                        <button type="button" id="fs-edit-user-profile" class="fs-edit-user-profile">Editar</button>
                    </div>
                    <form class="fs-comment-form" novalidate>
                        <textarea
                            name="comment"
